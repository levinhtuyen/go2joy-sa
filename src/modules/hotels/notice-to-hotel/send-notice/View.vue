<template>
<div>
    <div class="send-notice-segment">

        <SaSection v-loading="ui.isLoadingNoticeDetail">
        ...
        <div class="send-notice-segment__button">
          <el-button type="success" @click="onSendNotice" :disabled="checkDisplay" icon="el-icon-position">
              {{ $t('button.send')}}
          </el-button>
