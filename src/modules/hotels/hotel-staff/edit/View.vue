<template>
<div >
  <div class="hotel-staff-edit-segment">
        <SaSection v-loading="ui.isLoadingHotelStaffEdit">
            <!-- Start Contentbar-->
            <el-form
            ref="dataForm"
            ...
            class="hotel-staff-edit-segment__form">
                ...
                <el-form-item :label="$t('page.hotelStaffEdit.password')">
  ...
  methods: {
    async getDataHotelStaffById () {
      ...
      try {
        ...
        this.dataHotelStaffDetail.roleSn = this.dataHotelStaffDetail.role.sn
      ...
      this.$refs.dataForm.validate(async (valid) => {
        ...
        try {
          ...
          try {
            ...
            await updateStaffById(this.dataHotelStaffDetail.hotelSn, this.dataHotelStaffDetail)
            this.$message({
              type: 'success',
