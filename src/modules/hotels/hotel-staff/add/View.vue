<template>
<div >
  <div class="hotel-staff-create-segment">
        <SaSection v-loading="ui.isLoadingHotelStaffCreate">
            <!-- Start Contentbar-->
            <el-form
            ref="dataForm"
    ...
    async createHotelStafff () {
      this.$refs.dataForm.validate(async (valid) => {
        ...
        try {
          ...
          try {
            await createHotelStaff(this.dataHotelStaffDetail.hotelSn, this.dataHotelStaffDetail)
            this.$message({
              type: 'success',
