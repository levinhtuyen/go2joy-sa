<template>
<div>
    <div class="hotel-group-create-segment">
        <SaSection v-loading="ui.isLoadingHotelGroupCreate">
            <!-- Start Contentbar-->
            <el-form ref="dataCreatelHotelGroup" :model="dataCreatelHotelGroup" :rules="rules" label-position="left" label-width="25%" class="hotel-group-create-segment__form">
                <el-form-item :label="$t('page.hotelGroupAdd.namegroup')" prop="name">
                    <el-input :placeholder="$t('page.hotelGroupAdd.namegroup')" v-model="dataCreatelHotelGroup.name" />
                </el-form-item>
                <el-form-item :label="$t('page.hotelGroupAdd.ownerinformation')" prop="ownerName">
                  <div class="hotel-group-create-segment__form--col">
                    <div class="form-row">
                      <el-form-item prop="ownerName">
                        <el-input :placeholder="$t('page.hotelGroupAdd.ownername')" v-model="dataCreatelHotelGroup.ownerName" />
                      </el-form-item>
                  </div>
                  <div class="form-row-center">
                    <el-form-item  prop="ownerTel">
                      <el-input :placeholder="$t('page.hotelGroupAdd.ownertel')" v-model="dataCreatelHotelGroup.ownerTel" />
                    </el-form-item>
                  </div>
                  <div class="form-row">
                    <el-form-item  prop="ownerEmail">
                      <el-input :placeholder="$t('page.hotelGroupAdd.owneremail')" v-model="dataCreatelHotelGroup.ownerEmail" />
                    </el-form-item>
                  </div>
                  </div>
                </el-form-item>
                <el-form-item :label="$t('page.hotelGroupAdd.ownerinformation')">
                  <div class="hotel-group-create-segment__form--col">
                    <div class="form-row">
                      <el-input :placeholder="$t('page.hotelGroupAdd.companyname')" v-model="dataCreatelHotelGroup.companyName" />
                  </div>
                  <div class="form-row-center">
                      <el-input :placeholder="$t('page.hotelGroupAdd.businesslisencenumber')" v-model="dataCreatelHotelGroup.bln" />
                  </div>
                  <div class="form-row">
                      <el-input :placeholder="$t('page.hotelGroupAdd.companytel')" v-model="dataCreatelHotelGroup.companyTel" />
                  </div>
                  </div>
                </el-form-item>
                <el-form-item >
                  <div class="hotel-group-create-segment__form--col">
                    <div class="form-row">
                      <el-input :placeholder="$t('page.hotelGroupAdd.companyemail')" v-model="dataCreatelHotelGroup.companyEmail" />
                    </div>
