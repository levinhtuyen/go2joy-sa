<template>
<div>
    <div class="hotel-group-detail-segment">
        <SaSection v-loading="ui.isLoadingHotelGroupDetail">
            <!-- Start Contentbar-->
            ...
            <el-table :data="tableData" class="hotel-group-detail-segment__table">
                ...
                <el-table-column :label="$t('page.hotelGroupEdit.table_hotel_name')" min-width="10">
                ...
                <el-table-column :label="$t('page.hotelGroupEdit.table_status')" min-width="10">
                    <template slot-scope="scope">
                        <span> {{ setHotelStatus(scope.row.hotelStatus) }}</span>
                    </template>
                </el-table-column>
                <el-table-column :label="$t('page.hotelGroupEdit.table_phone')" min-width="10">
                    <template slot-scope="scope">
                        <span> {{ scope.row.phone }}</span>
                    </template>
                </el-table-column>
                <el-table-column :label="$t('page.hotelGroupEdit.table_address')" min-width="10">
                    <template slot-scope="scope">
                        <span> {{ scope.row.address }}</span>
                    </template>
                </el-table-column>
                <el-table-column :label="$t('page.hotelGroupEdit.table_commission')" min-width="10">
                    <template slot-scope="scope">
