...
<div>
    <div class="hotel-group-create-segment">
        <SaSection v-loading="ui.isLoadingHotelGroupEdit">
            <!-- Start Contentbar-->
            <el-form ref="dataEditHotelGroup" :model="dataEditHotelGroup" :rules="rules" label-position="left" label-width="25%" class="hotel-group-create-segment__form">
                <el-form-item :label="$t('page.hotelGroupEdit.namegroup')" prop="name">
                    <el-input :placeholder="$t('page.hotelGroupEdit.namegroup')" v-model="dataEditHotelGroup.name" />
                </el-form-item>
                <el-form-item :label="$t('page.hotelGroupEdit.ownerinformation')" prop="ownerName">
                  <div class="hotel-group-create-segment__form--col">
                    <div class="form-row">
                      <el-form-item prop="ownerName">
                        <el-input :placeholder="$t('page.hotelGroupEdit.ownername')" v-model="dataEditHotelGroup.ownerName" />
                      </el-form-item>
                  </div>
                  <div class="form-row-center">
                    <el-form-item  prop="ownerTel">
                      <el-input :placeholder="$t('page.hotelGroupEdit.ownertel')" v-model="dataEditHotelGroup.ownerTel" />
                    </el-form-item>
                  </div>
                  <div class="form-row">
                    <el-form-item  prop="ownerEmail">
                      <el-input :placeholder="$t('page.hotelGroupEdit.owneremail')" v-model="dataEditHotelGroup.ownerEmail" />
                    </el-form-item>
                  </div>
                  </div>
                </el-form-item>
                <el-form-item :label="$t('page.hotelGroupEdit.ownerinformation')">
                  <div class="hotel-group-create-segment__form--col">
                    <div class="form-row">
                      <el-input :placeholder="$t('page.hotelGroupEdit.companyname')" v-model="dataEditHotelGroup.companyName" />
                  </div>
                  <div class="form-row-center">
                      <el-input :placeholder="$t('page.hotelGroupEdit.businesslisencenumber')" v-model="dataEditHotelGroup.bln" />
                  </div>
                  <div class="form-row">
                      <el-input :placeholder="$t('page.hotelGroupEdit.companytel')" v-model="dataEditHotelGroup.companyTel" />
                  </div>
                  </div>
                </el-form-item>
                <el-form-item >
                  <div class="hotel-group-create-segment__form--col">
                    <div class="form-row">
                      <el-input :placeholder="$t('page.hotelGroupEdit.companyemail')" v-model="dataEditHotelGroup.companyEmail" />
                    </div>
...
export default {
  ...
  methods: {
    ...
    async editHotelGroup () {
      ...
      try {
        const { data } = await updateDataHotelGroupById(id, forData)
        this.dataRes = data
        this.$message({
          type: 'success',
