<template>
  <sa-section v-if="$route.fullPath === '/hotel/sadmin/hotel-display'" class="hotel-display">
    <div class="hotel-display__header">
      <div class="hotel-display__header--search">
        <div>
          <SaSelectCheck
        ...
        <div>
          <el-select @change="fetchHotelDisplays" v-model="filter.style">
            <el-option
...
import { statusOptionsV2, typeOptionsV2 } from '@/utils/const'
