  ...
  <sa-section v-loading="ui.isLoading">
    ...
    <el-form :model="form" :rules="rules" ref="form">
      ...
      <!-- --- BASIC INFO --- -->
        ...
        <div class="infomation">
            <div class="infomation__detail">
                ...
                <div class="infomation__detail--block">
                    ...
                    <div class="checkbox">
                        <el-radio class="mb-1" v-model="form.hotelPms.type" :label="0">{{ $t('page.hotelDisplay.noIJjustUse')}}</el-radio>
                          <div>
          ...
          <div class="infomation__detail">
            ...
            <div class="infomation__detail--right">
                ...
                <div class="input-label">
                  <el-input v-model="form.maxBooking"></el-input>
          ...
          <el-form-item :label="$t('page.hotelDisplay.location')" required>
            <div class="infomation__detail--map">
              <div class="map-search">
                <label>
                    <gmap-autocomplete class="el-input__inner" @place_changed="setPlace">
                    </gmap-autocomplete>
                </label>
                <el-button type="primary" @click="addMarker">{{ $t('button.add')}}</el-button>
              </div>
        ...
        <div class="validation__form">
          <el-form-item class="pb-1" :label="$t('page.hotelDisplay.commission')" prop="commission">
  ...
  data () {
    return {
      form: {
        ...
        // images
        images: [
          { file: '', src: '', is360: false, firstDisplay: 1, flag: 5, sn: 0, isImage: true },
          { file: '', src: '', is360: false, firstDisplay: 0, flag: 5, sn: 0, isImage: true },
          { file: '', src: '', is360: false, firstDisplay: 0, flag: 5, sn: 0, isImage: true },
          { file: '', src: '', is360: false, firstDisplay: 0, flag: 5, sn: 0, isImage: true },
          { file: '', src: '', is360: false, firstDisplay: 0, flag: 5, sn: 0, isImage: true },
          { file: '', src: '', is360: false, firstDisplay: 0, flag: 5, sn: 0, isImage: true },
  ...
  methods: {
    ...
    async submit () {
      ...
      try {
        ...
        await updateHotelDisplay(this.$route.params.sn, formData)
