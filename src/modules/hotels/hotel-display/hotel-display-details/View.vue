      ...
      <div>
        <div class="detail">
          <div class="detail__left">
            ...
            <div class="detail__left--white">
              <p>{{form.name }} ({{form.code }}) <b>{{hotelGroup.name}}</b></p>
            </div>
          </div>
        ...
        <div class="detail">
          <div class="detail__left">
            ...
            <div class="detail__left--white detail__left--flex">
              ...
              <p v-else-if="setting.receiveEmail === 1"><i class="el-icon-check"></i> {{$t('option.bookingNotificationBy.email')}}</p>
              <p v-else-if="setting.receiveNotify === 1"><i class="el-icon-check"></i> {{$t('option.bookingNotificationBy.go2joyParterApp')}}</p>
            </div>
          </div>
          <div class="detail__right">
            <div class="detail__right--gray">
        ...
        <div class="detail">
          <div class="detail__left">
            ...
            <div class="detail__left--white">
              <p>{{ province.name }} / {{ district.name }}</p>
            </div>
          </div>
          <div class="detail__right">
            <div class="detail__right--gray">
        ...
        <div class="detail">
          ...
          <div class="detail__right">
            ...
            <div class="detail__right--white">
              <p>BIC: {{ bizInCharge.fullName }}: SIC: {{ saleInCharge.fullName }}</p>
            </div>
          </div>
        </div>
        <div class="detail">
