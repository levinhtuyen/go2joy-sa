  ...
  >
    <div class="customs-edit-direct-discount">
      ...
      <el-row>
        ...
        <el-col :span="3">
          <label
            class="custom-checkbox day-of-weeks"
            :class="typeApply == 2 || disabled.monday == 1 ? 'disabled' : ' '"
          >
            <input type="checkbox" v-model="directDiscount.monday" />
        ...
        <el-col :span="3">
          <label
            class="custom-checkbox day-of-weeks"
            :class="typeApply == 2 || disabled.tuesday == 1 ? 'disabled' : ' '"
          >
            <input type="checkbox" v-model="directDiscount.tuesday" />
            <span class="checkmark"></span>
        ...
        <el-col :span="3">
          <label
            class="custom-checkbox day-of-weeks"
            :class="
              typeApply == 2 || disabled.wednesday == 1 ? 'disabled' : ' '
            "
          >
            <input type="checkbox" v-model="directDiscount.wednesday" />
            <span class="checkmark"></span>
        ...
        <el-col :span="3">
          <label
            class="custom-checkbox day-of-weeks"
            :class="typeApply == 2 || disabled.thursday == 1 ? 'disabled' : ' '"
          >
            <input type="checkbox" v-model="directDiscount.thursday" />
            <span class="checkmark"></span>
        ...
        <el-col :span="2">
          <label
            class="custom-checkbox day-of-weeks"
            :class="typeApply == 2 || disabled.friday == 1 ? 'disabled' : ' '"
          >
            <input type="checkbox" v-model="directDiscount.friday" />
            <span class="checkmark"></span>
        ...
        <el-col :span="3">
          <label
            class="custom-checkbox day-of-weeks"
            :class="typeApply == 2 || disabled.saturday == 1 ? 'disabled' : ' '"
          >
            <input type="checkbox" v-model="directDiscount.saturday" />
            <span class="checkmark"></span>
        ...
        <el-col :span="3">
          <label
            class="custom-checkbox day-of-weeks"
            :class="typeApply == 2 || disabled.sunday == 1 ? 'disabled' : ' '"
          >
            <input type="checkbox" v-model="directDiscount.sunday" />
            <span class="checkmark"></span>
...
<script>
import { getRoomType, listDirectDiscount, onCreateDirectDiscount, onCheckDayApply, onDeleteDirectDiscount } from '@/api/roomType'
