<template>
  ...
  >
    ...
    <el-row class="click-able" @click.native="handleClick(`edit`)">
      <el-col :span="4">
    ...
    <el-row class="click-able" @click.native="handleClick(`extra_fee`)">
      <el-col :span="4">
    ...
    <el-row class="click-able" @click.native="handleClick(`direct_discount`)">
      <el-col :span="4">
