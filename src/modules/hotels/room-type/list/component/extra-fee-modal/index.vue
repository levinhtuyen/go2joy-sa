    ...
    <div class="customs-edit-extra-fee">
      ...
      <el-row>
        ...
        <el-col :span="3">
          ...
          >
            <input type="checkbox" v-model="extraFee.monday" />
        ...
        <el-col :span="3">
          ...
          >
            <input type="checkbox" v-model="extraFee.tuesday" />
            <span class="checkmark"></span>
        ...
        <el-col :span="3">
          <label
            ...
            "
          >
            <input type="checkbox" v-model="extraFee.wednesday" />
            <span class="checkmark"></span>
        ...
        <el-col :span="3">
          ...
          >
            <input type="checkbox" v-model="extraFee.thursday" />
            <span class="checkmark"></span>
        ...
        <el-col :span="2">
          ...
          >
            <input type="checkbox" v-model="extraFee.friday" />
            <span class="checkmark"></span>
        ...
        <el-col :span="3">
          ...
          >
            <input type="checkbox" v-model="extraFee.saturday" />
            <span class="checkmark"></span>
        ...
        <el-col :span="3">
          ...
          >
            <input type="checkbox" v-model="extraFee.sunday" />
            <span class="checkmark"></span>
...
<script>
import { getRoomType, listExtraFee, onCreateExtraFee, onCheckDayApply, onDeleteExtraFee } from '@/api/roomType'
