  ...
  <div class="activities-detail-segment">
    ...
    <div class="activities-detail-segment__content" v-if="!isLoading">
        <div>
            <div class="activities-detail-segment__content--line">
                ...
                <div class="activities-detail-content" >
                    <p>{{ dataActivities.requestStaffName }} {{ this.formatDate(dataActivities.lastUpdate) }}</p>
                </div>
            </div>
            <div class="activities-detail-segment__content--line">
              <div class="activities-detail-title">
            ...
            <div class="activities-detail-segment__content--input">
              <el-input :placeholder="$t('page.activitiesDetail.reason_to_confirm')" v-model="confirm" type="text"></el-input>
            </div>
        </div>
        <div>
            ...
            <div class="activities-detail-segment__content--title">
              <div class="activities-detail-table-user">
                  <div class="activities-detail-table-user__account-sale-level">
                      <p class="activities-detail-table-user__account-sale-level--name">{{$t('page.activitiesDetail.level1')}}</p>
                  </div>
                  <div class="activities-detail-table-user__confirm">
                      <p v-if="allConfirm === 0" class="activities-detail-table-user__confirm--title">{{$t('page.activitiesDetail.single_confirm')}}</p>
                      <p v-if="allConfirm === 1" class="activities-detail-table-user__confirm--title">{{$t('page.activitiesDetail.all_confirm')}}</p>
                  </div>
    ...
    <div v-if="!isLoading" class="activities-detail-segment__button">
        <div class="activities-detail-segment__button--content">
            <el-button type="success" size="large" @click="onConfirmActivities" v-if="dataActivities.allowConfirm == true && dataActivities.status == 1">
                <i class="feather icon-check"></i>
                {{$t('page.activitiesDetail.confirmed')}}
            </el-button>
              <el-button type="danger" size="large" @click="onWithdrawActivities"  v-if="dataActivities.allowConfirm == true && dataActivities.status == 1">
