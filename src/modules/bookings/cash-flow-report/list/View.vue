<template>
  <div class="cash-flow-mgt">
    <sa-section>
      ...
      <div class="cash-flow-mgt__table">
        <div>
          <el-table :data="data" v-loading="ui.isTableLoading">
            ...
            <el-table-column :min-width="100">
              <template slot="header">
                <p><span class="text-danger">(1)</span>{{ this.$t('page.cashFlowReport.product_amount') }}</p>
              </template>
              <template slot-scope="scope">
                <p>
            ...
            <el-table-column :min-width="100">
              <template slot="header">
                <p><span class="text-danger">(4)</span>{{ this.$t('page.cashFlowReport.user_pay') }}</p>
              </template>
              <template slot-scope="scope">
                <p>
            ...
            <el-table-column :min-width="110">
              <template slot="header">
                ...
                <p><span class="text-danger">(6)</span><span class="text-danger">(2)</span><span class="text-danger">(5)</span></p>
              </template>
              <template slot-scope="scope">
                <p>
              ...
              <template slot-scope="scope">
                ...
                >
                  ...
                  <div class="operations">
                    <router-link :to="{name: ''}" v-if="scope.row.origin != 2" class="el-link el-link--default">
                      hotel debt
                    </router-link>
                    <el-link @click="onExportById(scope.row.hotelSn)">
                      {{ $t('button.export') }}
                    </el-link>
                  </div>
                </el-popover>
  ...
  data () {
    return {
      ...
      ui: {
        ...
        originHotel: [
          { key: this.$t('page.cashFlowReport.all_inventory'), value: 0 },
          { key: 'Go2Joy', value: 1 },
          { key: 'Agoda', value: 2 }
        ]
      },
