...
<div class="dashboard-block">
    <div class="confirm-group-segment"  v-loading="ui.loadingConfirmGroup">
        ...
        >
          ...
          <el-table-column :label="$t('page.confirmGroup.operations')" align="center" min-width="5">
              <template slot-scope="scope">
        ...
        <div class="confirm-group-segment__footer">
          <el-pagination
...
export default {
  ...
  data (vm) {
    return {
      ...
      dataRes: null,
      types: [
        { label: vm.$t('option.type.transfer_booking'), value: 4 },
        { label: vm.$t('option.type.promotion'), value: 1 },
        { label: vm.$t('option.type.invite_friend'), value: 2 },
        { label: vm.$t('option.type.product'), value: 3 }
      ],
      regions: [
        { label: vm.$t('option.region.all_region'), value: 0 },
        { label: vm.$t('option.region.south'), value: 1 },
        { label: vm.$t('option.region.north'), value: 2 },
        { label: vm.$t('option.region.middle'), value: 3 }
      ],
      levels: [
        { label: vm.$t('option.level.level1'), value: 1 },
        { label: vm.$t('option.level.level2'), value: 2 }
      ],
      confirms: [
        { label: 'option.regionConfirm.confirm', value: 1 },
        { label: 'option.regionConfirm.view', value: 0 }
      ],
      allConfirm: {
        options: [
