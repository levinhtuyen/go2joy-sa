    ...
    >
      <div class="article-form__image">
        ...
        <div class="article-form__image--wrapper">
          <img v-if="formData.imagePath && !imageSrc" :src="formData.imagePath" alt="image-article">
          <img v-if="imageSrc" :src="imageSrc" alt="image-article">
        </div>
        <upload-file
