<template>
  <sa-section class="inviteFriend" v-loading="ui.isLoading">
    <el-form :model="form" :rules="rules" ref="form">
      <div class="inviteFriend__form">
      ...
      <div class="inviteFriend__form">
        <el-form-item :label="$t('page.inviteFriend.startEndDate')" prop="startDate" required>
           <div class="inviteFriend__row">
              <div class="inviteFriend__row--margin">
                <el-form-item>
      ...
      <div class="inviteFriend__form">
        <el-form-item :label="$t('page.inviteFriend.dailyBudget')">
          <div class="inviteFriend__row">
            <div class="inviteFriend__row--margin">
              <el-form-item>
                <el-input-number class="w-100" :controls="false" v-model="form.dailyBudget" :min="0"></el-input-number>
              </el-form-item>
              </div>
            <div class="inviteFriend__row--margin">
                <b class="mr-1">VNĐ</b>
      ...
      <div class="inviteFriend__form">
        <el-form-item :label="$t('page.inviteFriend.guidelinesVn')" prop="guideline" required>
          <div class="inviteFriend__content">
