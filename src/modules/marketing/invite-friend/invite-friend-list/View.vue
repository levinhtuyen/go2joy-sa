<template>
  <sa-section v-if="$route.fullPath === '/hotel/sadmin/invite-friend'" class="inviteFriend">
    <div class="inviteFriend__header">
      <div class="inviteFriend__header--account">
        <div>
      ...
      <div class="inviteFriend__header--add">
        <el-button
          type="warning"
          plain
          @click="handleCreate"
