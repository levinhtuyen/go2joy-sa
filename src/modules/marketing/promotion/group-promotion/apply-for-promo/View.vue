      ...
      <div class="promo__filters">
        ...
        >
          <el-form-item>
            ...
            >
              <el-option
                v-for="(item, index) in ui.applyTargetType"
                :key="index"
                :label="$t(item.key)"
                :value="item.value"
              />
          ...
          <el-form-item>
            ...
            >
              <el-option
                v-for="(item, index) in ui.promoType"
                :key="index"
                :label="$t(item.key)"
                :value="item.value"
              />
...
import { onAddPromotionApply, onRemovePromotionApply, onSavePromotionApply, onBackPromotionApply } from './api'
  ...
  methods: {
    ...
    getDiscountType (json) {
      switch (json.discountType) {
        case 1:
          return json.discount + ' VND'
        case 2:
          return json.discount + ' %'
        case 5:
          return (
            '<span class="bold" style="font-weight: bold">ĐG</span> ' +
            json.discount
          )
      }
    },
