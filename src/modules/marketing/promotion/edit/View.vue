  ...
  <sa-section v-loading="ui.isLoading">
    ...
    >
      ...
      <el-form-item
        ...
        prop="contentEn"
      >
        <tinymce v-model="promotion.contentEn" name="contentEn" :height="300" />
      </el-form-item>
      <el-form-item
  ...
  methods: {
    async getPromotion () {
      ...
      try {
        ...
        this.ui.applyStartEnd = this.promotion.numActiveDay > 0 ? 1 : 0
        ...
        if (this.$route.query.page !== 'copy') {
          this.promotion.imageList.forEach((value, index) => {
      ...
      this.$refs.ruleForm.validate(async (valid) => {
        if (valid) {
          try {
            ...
            formData.append('calMaxDiscount', this.promotion.calMaxDiscount)
            formData.append('afterDiscount', this.promotion.afterDiscount)
            ...
            formData.append('typesOfDisplay', this.promotion.typesOfDisplay)
            if (this.promotion.typesOfDisplay === 1) {
            ...
            if (this.arrPromotionGroups && this.arrPromotionGroups.length > 0) {
            ...
            formData.append(
              'numActiveDay',
              this.applyStartEnd === 1 ? this.promotion.numActiveDay : 0
            )
