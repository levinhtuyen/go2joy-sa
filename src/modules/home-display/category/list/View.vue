        ...
        <template slot-scope="scope">
          ...
          >
            ...
            <div style="padding: 8px 12px;">
              ...
              <el-button
                v-if="isShowManagementButton(scope.row.sn)"
                type="primary"
                size="small"
                plain
...
export default {
  ...
  methods: {
    ...
    handleManagement (sn) {
      if (sn === 4) {
        this.$router.push('/hotel/sadmin/collection')
      }
    },
    //
    isShowManagementButton (sn) {
      return sn === 1 || sn === 2 || sn === 4 || sn === 7
    },
